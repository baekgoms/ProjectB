...
$(document).ready(function(){
	$("#id").change(function(){
		$.ajax({
			url:"/projectB/petitioner/confirmId.aa",
			data:{ id : $("#id").val() },
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                <div class="col-lg-12 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center">답변자 계정 생성</h2>
                        <form class="mt-4" action="insertAnswer.aa" onSubmit="return signUpCheck()" method = "post">
                            <div class="row">
                                <!-- ID -->
                                <div class="col-lg-10">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input id="department" name = "department" class="form-control" type="text"	placeholder="부서를 입력하세요">
									</div>
								</div>
