...
<body>
	<div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin6" style="background-color: #082e59;">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" style="border-bottom: 1px solid #082e59;">
                	<ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                		<li class="nav-item dropdown">
                			<a href="/projectB/petition/afootPetition.aa">
                				<strong style="position: relative; left: -525px; color: white;">
                					국민 청원
                				</strong>
                			</a>
                		</li>
                		...
                		<li class="nav-item dropdown">
                			<a href="/projectB/discussion/main.aa">
                				<strong style="position: relative; left: 35px; color: white;">
                					토론방
                				</strong>
                			</a>
                		</li> 
