                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="/projectB/resource/bootstrap/assets/images/logo-text2.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="/projectB/resource/bootstrap/assets/images/users/imNotTired.jpg" alt="user" class="rounded-circle"
                                    width="40">
                                <span class="ml-2 d-none d-lg-inline-block"><span>반갑습니다,</span> <span
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/projectB/question/board.aa"
