...
<div class="page-wrapper">
	<input type="button" value="                           뉴스피드                              " class="btn waves-effect waves-light btnoutline-dark" 
		onclick="document.location.href='/projectB/mypage/keywordNews.aa'" style="height:70px; width:400px;">
	<input type="button" value="                         키워드 등록                           " class="btn waves-effect waves-light btn-dark" 
		onclick="document.location.href='javascript:void(0)''" style="height:70px; width:400px;">
<div class="col-12">
<br><br>
</div>
<form action="/projectB/mypage/keywordInsert.aa" method="post">
<table><tr><td>
	<input type="text" name="tag" class="form-control" style="width:500px"></td>
	<td width="30"></td>
	<td> <input type="submit" value="키워드 등록" class="btn waves-effect waves-light btn-outline-dark"></td></tr>
</table>
</form>
...
<tr align="center">
<td width="700">${tag.tagName}</td>
<td><input type="button" onclick="document.location.href='/projectB/mypage/keywordDelete.aa?tag=${tag.tagName}'"
		value="삭제" class="btn waves-effect waves-light btn-outline-dark">
</c:forEach>
</table>
</div>
</div>
