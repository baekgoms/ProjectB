...
public class petitionListController {
	...
	public String ing_listbyCategory(@RequestParam(defaultValue = "1") int pageNum, Model model, int category)
			throws Exception {
	...
	public String ing_listSearch(@RequestParam(defaultValue = "1") int pageNum, Model model, String keyword)
			throws Exception {
		int pageSize = 10;
		int currentPage = pageNum;
		int startRow = (currentPage - 1) * pageSize + 1;
